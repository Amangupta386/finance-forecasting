...
import '../providers/projects/add_new_projects_provider.dart';
import '../theme/styles.dart';

class AddNewFormDropdownFields extends StatefulWidget {
  final String label;
  final List<DropDownModel> items;
  AddNewFormDropdownFields({Key? key, required this.label, required this.items})
      : super(key: key);
...
class _FormDropdownFieldState extends State<AddNewFormDropdownFields> {
  ...
  Widget build(BuildContext context) {
    ...
    // List<AddNewProject> items = provider.projectDropDownValue();
