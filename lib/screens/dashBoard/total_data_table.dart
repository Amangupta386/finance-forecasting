              ...
              children: [
                ...
                Text(
                    ((isAndroid || isTablet) || (!isMonitor && !isLaptop))
                        ? MasterData
                                .dashboardAndProjectTotalColumnTitlesResponsive[
                            index]
                        : MasterData
                            .dashboardAndProjectTotalColumnTitles[index],
                          ...
                          cells: List.generate(
                            ...
                            if (colIndex == 0) {
                              ...
                              return DataCell(Container(
                                ...
                                child: (colIndex == 1)
                                    ? Text(
                                        resourceCostRowData.totalYF.toString())
                    ...
                    .mapIndexed((rowIndex, monthBreakdownRowData) => DataRow(
                          cells: List.generate(
                              MasterData.dashboardAndProjectTotalColumnTitles
                                  .length, (colIndex) {
                            if (colIndex == 0) {
                              return DataCell(monthBreakdownRowData
                                      .isDottedLine //(rowIndex == 5 || rowIndex == 7)
                                  ? const CustomDottedLine()
                                  : SizedBox(
                                      width: deviceWidth / 10,
                                      child: Text(
                                        monthBreakdownRowData.label,
                                ...
                                monthBreakdownRowData
                                    .isSelectIconHide /*rowIndex == 6*/) {
                              return DataCell(
                                Center(
                                  child: Container(
                                    margin: EdgeInsets.only(left: Insets.s15),
                                    color: kGrey,
                                    width: 1,
                                  ),
                                ),
                                  ...
                                  ? Stack(children: [
                                      ...
                                      Center(
                                        child: Container(
                                          width: 1,
                                          color: colorTheme.onPrimary,
                                          margin: monthBreakdownRowData
                                                  .isDottedLine //rowIndex == 7
                                              ? EdgeInsets.only(
                                                  // bottom: Insets.s24,
                                                  left: (!projectsProvider
                                                          .toMoveNavigator)
                                                      ? Insets.s15
                                                      : 0)
                                              : (!projectsProvider
                                              ...
                                              if (projectsProvider
                                                ...
                                                return Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    child: (monthBreakdownRowData
                                                                .label !=
                                                            'Monthly Deviation')
                                                        ? (monthBreakdownRowData
                                                                .isTotalSelected)
                                                            ? CircleAvatar(
                                                                backgroundColor: monthBreakdownRowData
                                                                        .isTotalSelected
                                                                    ? colorTheme
                                                                        .primary
                                                                    : monthBreakdownRowData
                                  ...
                                  builder: (context, provider, child) {
                                    return Padding(
                                      padding: EdgeInsets.only(
                                          ...
                                          bottom: Insets.s4),
                                      child: (colIndex == 1)
                                          ? Text(monthBreakdownRowData.totalFY)
                                          : Text(
                                              monthBreakdownRowData.totalYTD),
                                    );
                                  },
                                ),
                              ));
