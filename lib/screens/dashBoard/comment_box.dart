...
class CommentBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      left: (xPosition < 1230) ? xPosition : xPosition - 288,
      top: yPosition,
      child: ShapeOfView(
        shape: BubbleShape(
          position:
              (xPosition < 1230) ? BubblePosition.Left : BubblePosition.Right,
          ...
          child:
            ...
            Container(
              ...
              child: (!Provider.of<ProjectsProvider>(context).toMove)
                  ? Text(provider.commentMessage[provider.commentRowIndex][provider.commentColumnIndex])
                  : TextField(
