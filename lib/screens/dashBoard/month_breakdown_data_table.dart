...
class _MonthDataTableState extends State<MonthDataTable> {
  ...
  void initState() {
    super.initState();
    Provider.of<DashboardProvider>(context, listen: false).updateDashboardAndProjectMonthBreakdownData();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          horizontalMargin: (projectsProvider.toMoveNavigator == true) ? Insets.s20 : Insets.s10,
          columnSpacing: 2,
          columns: List<DataColumn>.generate(
            provider.dashboardAndProjectMonthBreakdownData[0].monthValues!.length,
            (index) => DataColumn(
                label: Row(children: [
              SizedBox(
                width: deviceWidth / 50,
              ),
              Text(provider.dashboardAndProjectMonthBreakdownData[0].monthValues![index]
                    .label,
          ...
          rows: (widget.headingText == Labels.otherExpense)
              ? provider.dashboardAndProjectOtherExpenseModelData.map((expenseRowData) => (
              DataRow(
            cells: List.generate(
                  ...
                  return DataCell(
                    Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: !expenseRowData.monthValues[colIndex].isValid
                                    ? colorTheme.onTertiaryContainer
                                    : colorTheme.onPrimary,
                                width:
                                ( expenseRowData.monthValues[colIndex].isValid) ? 1 : 1.5),
                        ...
                        child: Consumer<DashboardProvider>(
                          builder: (a, provider, c){
                            return CustomTextFormField(
                              ...
                              colLength: expenseRowData.monthValues!.length,
                            );
                          },
                        )),
                  );
                  ...
                  return DataCell(
                    Container(
                        ...
                        decoration: BoxDecoration(
                            color: colorTheme.onPrimaryContainer,
                            border: Border.all(
                                color: resourceCostRowData.monthValues[colIndex].isValid
                                    ? colorTheme.onPrimary
                                    : colorTheme.onTertiaryContainer,
                                width: resourceCostRowData.monthValues[colIndex].isValid
                                    ? 1
                                    : 1.5),
                            borderRadius: BorderRadius.circular(3)),
                        child: CustomTextFormField(
                          ...
                          rowLength: 6,
                          colLength: resourceCostRowData.monthValues!.length,
                    ...
                    monthBreakdownRow.isSelect
                        ...
                        child: CustomTextFormField(
                          ...
                          colLength: monthBreakdownRow
                              .monthValues!
                              .length,
                          monthBreakdownRowData: monthBreakdownRow,
                        ))
                        : MouseRegion(
                      onEnter: (event){
                        monthBreakdownRow.enterMonthBlock(cellIndex);
                      },
                      onExit: ( event) {
                        monthBreakdownRow.exitMonthBlock(cellIndex);
                      },
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color:
                                  monthBreakdownRow.monthValues[cellIndex].isValid
                                      ? colorTheme.onPrimary
                                      :  colorTheme.onTertiaryContainer,
                                  width: monthBreakdownRow.monthValues[cellIndex].isValid
                                      ? 1
                                      : 1.5),
                              borderRadius:
                          ...
                          child: Stack(
                            children: [
                              if (monthBreakdownRow.monthValues[cellIndex].monthBlock)
                                Positioned(
                                  left: iconPosition,
                                  child: MouseRegion(
                                    onEnter:
                                        (PointerEnterEvent
                                    event) {
                                      monthBreakdownRow.enterMonthIcon(cellIndex);
                                    },
                                    onExit: (PointerExitEvent
                                    event) {
                                      monthBreakdownRow.exitMonthIcon(cellIndex);
                                    },
                                    child: GestureDetector(
                                      ...
                                      child: Icon(
                                        (!projectsProvider
                                            ...
                                            .noteAdd,
                                        size: iconSize,
                                        color: (monthBreakdownRow.monthValues[cellIndex].monthIcon)
                                            ? colorTheme.onPrimary
