    ...
    provider.dashboardAndProjectMonthTextValue = List.generate(
        ...
        (rowIndex) => List<String>.generate(
            ...
            (cellIndex) => (rowIndex == 0)
                ? provider.localData[rowIndex].forecastedRevenue[cellIndex]
                : (rowIndex == 1)
        ...
        child: DataTable(
          ...
          columns: List<DataColumn>.generate(
            ...
            (index) => DataColumn(
              ...
              Text(
                MasterData.dashboardAndProjectMonthColumnsNames[index],
          ...
          rows: (widget.headingText == Labels.otherExpense)
              ...
              : (widget.headingText == Labels.resourceCostHeading)
                  ...
                  : List<DataRow>.generate(
                      provider.localData.length,
                      (rowIndex) => DataRow(
                        cells: List.generate(
                            MasterData.dashboardAndProjectMonthColumnsNames
                                .length, (cellIndex) {
                          return DataCell(
                                ...
                                : provider.isSelect[rowIndex]
                                    ? Padding(
                                        ...
                                        child: CustomTextFormField(
                                          ...
                                          rowLength: MasterData
                                              .dashboardAndProjectMonthRowNames
                                              .length,
                                          colLength: MasterData
                                              .dashboardAndProjectMonthColumnsNames
                                              .length,
                                        ))
                                    : MouseRegion(
                                        ...
                                        child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                border: Border.all(
                                                    color: provider.isValidMonthBreakdown[
                                                            rowIndex][cellIndex]
                                                        ? kRed
                                                        : kGrey,
                                                    width: (provider.isValidMonthBreakdown[
                                                                rowIndex]
                                                            [cellIndex])
                                                        ? 1.5
                                                        : 1),
                                            ...
                                            child: Stack(
                                              children: [
                                                ...
                                                CustomTextFormField(
                                                  ...
                                                  rowLength: MasterData.dashboardAndProjectMonthRowNames.length,
                                                  colLength: MasterData
                                                      .dashboardAndProjectMonthColumnsNames
                                                      .length,
                                                ),
