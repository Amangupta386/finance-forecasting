        ...
        Builder(builder: (context) {
          ...
          return Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: provider.isValidResourcesCost[rowIndex][colIndex]
                          ? kRed
                          : kGrey,
                      width: (provider.isValidResourcesCost[rowIndex][colIndex])
                          ? 1.5
                          : 1),
      ...
      if (colIndex == 0) {
        return DataCell(Builder(builder: (context) {
          ...
          return SizedBox(
              width: mQ.width / 11.8,
              child: Text(
                MasterData.dashboardAndProjectResourceCostData[rowIndex].label,
                style: (isAndroid)
