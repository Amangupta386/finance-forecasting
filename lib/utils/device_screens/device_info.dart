...
enum FormFactorType { monitor, smallPhone, largePhone, tablet,largeScreen }
...
class DeviceScreen {
  ...
  static FormFactorType get(BuildContext context) {
    ...
    if (shortestSide <= 1600) return FormFactorType.largeScreen;
  ...
  static bool isLargeScreen(BuildContext context) => get(context) == FormFactorType.largeScreen;
}