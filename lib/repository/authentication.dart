...
class AuthenticationRepository extends BaseService {
  ...
  Future<LoginModel> loginAuthentication(
    ...
    try {
      ...
      ColorScheme? themeColor = Theme.of(rootNavigatorKey.currentState!.context).colorScheme;
      TopSnackBar.showTopSnackBar(rootNavigatorKey.currentState!.context,
          Labels.wrongCredentialsMessage,themeColor.error,themeColor.tertiary,themeColor.tertiary);
