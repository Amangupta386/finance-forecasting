...
class TotalColumnGridTable extends StatefulWidget {
  ...
  TotalColumnGridTable(
      {Key? key,
      required this.indexEachCellData,
      required this.indexTotalFYData,
      required this.indexTotalYTData})
      : super(key: key);
        ...
        children: [
          ...
          DataTable(
            ...
            columns: List<DataColumn>.generate(
              ...
              (index) => DataColumn(label: SizedBox.shrink()),
            ),
            rows: List<DataRow>.generate(
              lastName.length,
              (index) => DataRow(
