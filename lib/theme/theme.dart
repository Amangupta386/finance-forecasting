...
class AppTheme {
  ...
  static ThemeData buildTheme() {
    final ColorScheme colorScheme = ColorScheme.fromSeed(
        ...
        onPrimaryContainer: kLightGreyShade,
        tertiaryContainer: kLightGrey);
    ...
    return base.copyWith(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.all(Radius.circular(Insets.s3)),
        ),
      )),
      ...
      textButtonTheme: TextButtonThemeData(
        ...
        foregroundColor: kWhite,
        padding:
            EdgeInsets.symmetric(vertical: Insets.s1, horizontal: Insets.s18),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.all(Radius.circular(Insets.s2)),
        ),
      )),
    );
  }
