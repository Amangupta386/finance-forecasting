      ...
      ShellRoute(
          ...
          pageBuilder:
              (BuildContext context, GoRouterState state, Widget child) {
                Widget? screen ;
                final isAuthenticated =  Provider.of<AuthProvider>(context, listen: false).auth;
                if (isAuthenticated ) {
                  ...
                  GoRoute(
                    ...
                    // },
                      pageBuilder: (context,state){
                        ...
                        final isAuthenticated =  Provider.of<AuthProvider>(context, listen: false).auth;
                        if (isAuthenticated ) {
                          screen = const ProjectChartScreen() ;
                        } else {
                          screen = const LoginScreen();
                        }
                        return CustomTransitionPage<void>(
...
//     final initialRoute =  Provider.of<AuthProvider>(context, listen: false).getInitialRoute();
//     // Logic to determine initial route based on authentication
