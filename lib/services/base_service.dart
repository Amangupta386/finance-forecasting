...
class BaseService {
  ...
  Future<dynamic> makeRequest<T>(
      ...
      {required String url, Map<String,dynamic>? header, String? baseUrl, required HttpMethod method, Map<String, dynamic>? body,
      ...
      case HttpMethod.get:
        ...
        response = await dio.get<T>(url,
            ...
            options: Options(headers: {
              'Bearer': "${dio.options.headers['Authorization']}"
            }));
        // print(response.data);
        return response.data;
