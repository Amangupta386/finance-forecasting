...
//     if (newData == false && prefs.getString('monthBreakDownValue') != null) {
//       return;
//     }
//     final List jsonData;
//     String jsonString;
...
//     await prefs.setString('monthBreakDownValue', jsonString);
//     if (newData) {
...
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//     final decodedList;
//     final jsonStrings = prefs.getString('monthBreakDownValue');
//     if (jsonStrings != null) {
//       final decoded = jsonDecode(jsonStrings);
//       decodedList = decoded.map((item) => MonthBreakdownModel.fromJson(item)).toList();
//       return decodedList;
//     }
//   }
// }
